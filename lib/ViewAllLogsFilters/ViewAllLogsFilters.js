      ...
      <AccordionSet>
        ...
        >
          <div data-test-job-profiles-filter>
            <FormattedMessage id="stripes-data-transfer-components.filter.chooseJobProfile">
              {([placeholder]) => (
                <Selection
        ...
        >
          <div data-test-users-filter>
            <FormattedMessage id="stripes-data-transfer-components.filter.chooseUser">
              {([placeholder]) => (
                <Selection
        ...
        <Accordion
          ...
          header={FilterAccordionHeader}
          label={<FormattedMessage id="stripes-data-transfer-components.filter.singleRecordImports" />}
