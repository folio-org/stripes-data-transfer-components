...
export class SearchAndSortPane extends Component {
  ...
  getSource() {
    ...
    const props = this.props.parentResources ? this.getPropsWithFilteredRecords() : this.props;

    return makeConnectedSource(props, stripes ? stripes.logger : { log: noop }, resourceName);
  }
